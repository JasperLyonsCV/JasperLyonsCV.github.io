...
function AboutMe() {
  return (
    <div>
      <h5 style={{paddingTop: '49px'}}><b>About Me</b></h5>   
      <p>
...
function ReferencesAndPortfolio() {
  return (
    <div>
      <h5><b>References/Portfolio</b></h5>  
      <p>
        Will provide employer/tertiary references and code portfolio upon request.
        View the code used to build this page at: <a href="https://jasperlyonscv.github.io/" className="codeLink">https://jasperlyonscv.github.io/</a>
      </p>
    </div>
  );
}
